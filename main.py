...
import sys
sys.path.append('D:/pythonCode/conpare/reTrain/MRNet1/MRNet')

def parse_config():
    parser = argparse.ArgumentParser("Training and evaluation script")
    parser.add_argument("--config", default="D:/pythonCode/conpare/reTrain/MRNet1/MRNet/configs/MRNet/cod_MRNet.py", type=str)
    parser.add_argument("--datasets-info", default="D:/pythonCode/conpare/reTrain/MRNet1/MRNet/configs/_base_/dataset/dataset_configs1.json", type=str)
    parser.add_argument("--model-name", default='MRNet',type=str)
    parser.add_argument("--batch-size", type=int)
    parser.add_argument("--load-from", default='D:/pythonCode/conpare/reTrain/MRNet1/MRNet/output/MRNet_BS6_LR0.005_E40_H384_W384_OPMsgd_OPGMfinetune_SCf3_AMP_INFOdemo/pth/state_final.pth',type=str)
    ...
    tr_paths = {}
    # print(config.datasets.train.path)
    # config.datasets.test.path.append('camo_te1')
    # config.datasets.test.path.append('cod10k_camo_tr')
    # print(config.datasets.test.path)
    ...
    print(f'config.datasets.test.path{config.datasets.test.path}')
    te_paths = {}
    for te_dataset in config.datasets.test.path:
        if te_dataset not in datasets_info:
            ...
            print("pass: ", te_dataset)
            continue
        print('load:',te_dataset)
